...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Piedro"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Hammer"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("123456789"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("piedro@email.com"))
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("PiedroUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("HammerUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("123456789"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("piedro@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("5000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("123123"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "PiedroUpdate",
        lastName: String = "HammerUpdate",
        income: BigDecimal = BigDecimal.valueOf(5000.0),
        zipCode: String = "123123",
